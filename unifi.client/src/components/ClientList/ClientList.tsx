...
import { ColDef, ColGroupDef, RowClassParams, ValueGetterParams } from "ag-grid-community";
...
export const ClientList: React.FunctionComponent<{}> = (): JSX.Element => {
    ...
    const {
        items
    } = useSelector((state: RootState) => state.clientList);
    ...
    const [columnDefs] = useState<((ColDef<UniClient, any> | ColGroupDef<UniClient>)[] | null | undefined)>([
