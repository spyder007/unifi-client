...
export const ClientApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        clientProvisionClient: async (provisionRequest: ProvisionRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'provisionRequest' is not null or undefined
            assertParamExists('clientProvisionClient', 'provisionRequest', provisionRequest)
...
export const ClientApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async clientDeleteClient(mac: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.clientDeleteClient(mac, options);
         ...
         * @throws {RequiredError}
         */
        async clientGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultOfListOfUniClient>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.clientGet(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async clientProvisionClient(provisionRequest: ProvisionRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceResultOfUniClient>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.clientProvisionClient(provisionRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ClientApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        clientDeleteClient(mac: string, options?: any): AxiosPromise<ServiceResult> {
            return localVarFp.clientDeleteClient(mac, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Gets this instance.
        ...
        clientGet(options?: any): AxiosPromise<ServiceResultOfListOfUniClient> {
            return localVarFp.clientGet(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {ProvisionRequest} provisionRequest 
         ...
         * @throws {RequiredError}
         */
        clientProvisionClient(provisionRequest: ProvisionRequest, options?: any): AxiosPromise<ServiceResultOfUniClient> {
            return localVarFp.clientProvisionClient(provisionRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ClientApi extends BaseAPI {
    ...
    public clientDeleteClient(mac: string, options?: any) {
        return ClientApiFp(this.configuration).clientDeleteClient(mac, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public clientGet(options?: any) {
        return ClientApiFp(this.configuration).clientGet(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ClientApi
     */
    public clientProvisionClient(provisionRequest: ProvisionRequest, options?: any) {
        return ClientApiFp(this.configuration).clientProvisionClient(provisionRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const InfoApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async infoGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Info>> {
